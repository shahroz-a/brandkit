...
const LOGO_TARGETS: AssetTarget[] = [
  logo("logo-icon", "Logo Icon", "brand-logo-icon.svg", 512, 512),
  logo(
    "logo-horizontal",
    "Horizontal Logo",
  ...
  logo("logo-vertical", "Vertical Logo", "brand-logo-vertical.svg", 720, 720),
  logo("logo-light", "Light Logo", "brand-logo-light.svg", 1200, 360),
  logo("logo-dark", "Dark Logo", "brand-logo-dark.svg", 1200, 360),
];
...
export function generateBrandAssets(
  ...
  return [
    ...
    svgAsset(
      "logo-horizontal",
      "Horizontal Logo",
      `${slug}-logo-horizontal.svg`,
      "logo",
      renderLogoSvg(tokens, "horizontal"),
      1200,
      360,
    ),
    svgAsset(
      "logo-vertical",
      "Vertical Logo",
      `${slug}-logo-vertical.svg`,
      "logo",
      renderLogoSvg(tokens, "vertical"),
      720,
      720,
    ),
    svgAsset(
    ...
    ...SOCIAL_TARGETS.map((target) => ({
      ...target,
      content: renderOpenGraphSvg(tokens, {
        width: target.width ?? 1200,
        height: target.height ?? 630,
      }),
    })),
  ];
}
...
function jsonAsset(
  ...
  filename: string,
  content: string,
  category: BrandAsset["category"] = "brand",
): BrandAsset {
  return {
    id,
    name,
